...
public class WikidataIdMappings {
	...
	private Map<Language, Cache<String, Entity>> entitiesByWikipediaLabels;
	...
	public void load(boolean loadWikidataLabels) {
		...
		this.entitiesByWikidataNumericIds = cacheManager.createCache("entitiesByWikidataNumericIds",
				CacheConfigurationBuilder.newCacheConfigurationBuilder(Integer.class, Entity.class,
						ResourcePoolsBuilder.heap(2000).offheap(1, MemoryUnit.GB)).build());
	...
	private void loadWikidataIdMapping() {
		...
		this.entitiesByWikipediaLabels = new THashMap<Language, Cache<String, Entity>>();
		...
		for (Language language : this.languages) {
			...
			this.entitiesByWikipediaLabels
					.put(language,
							cacheManager.createCache("entitiesByWikipediaLabels" + language.getLanguageLowerCase(),
